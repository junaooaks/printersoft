...
<body>
<div align="center">
  <table width="800" border="0" align="center" cellpadding="3" style="background:#ccf">
    <tr> 
    ...
    <tr>
      <td width="340" style="font-size:10px; font-family:Verdana;"><?php echo $_SESSION['nomeclixy']; ?></td>
