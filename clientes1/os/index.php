      ...
      <td width="585"><fieldset>
        ...
        <table width="700" border="0" cellpadding="0" cellspacing="5">
          ...
          <tr>
            ...
            <td><input name="empresa" type="text" id="nome3" value="<?php echo htmlentities($empresa, ENT_QUOTES, 'UTF-8'); ?>" size="90" readonly="readonly"/></td>
          </tr>
          <tr>
            <td style="font-size:10px; font-family: Verdana;">Solicitante/Respons.:</td>
            <td><input name="nome" type="text" id="nome5" value="<?php echo htmlentities($nome, ENT_QUOTES, 'UTF-8'); ?>" size="90" readonly="readonly"/></td>
          </tr>
          <tr>
            <td style="font-size:10px; font-family: Verdana;">Email:</td>
            <td><input name="email" type="text" id="nome" value="<?php echo htmlentities($email, ENT_QUOTES, 'UTF-8'); ?>" size="90" readonly="readonly"/></td>
          </tr>
        </table>
        ...
        <table width="700" border="0" cellspacing="5" cellpadding="0">
          <tr>
            ...
            <td colspan="5" style="font-size:10px; font-family: Verdana;">
              <input name="equi" type="text" id="equi" value="<?php echo htmlentities($equip, ENT_QUOTES, 'UTF-8'); ?>" readonly="readonly" />
Marca/Fab.*:
<input name="equi2" type="text" id="equi2"  value="<?php echo htmlentities($marcc, ENT_QUOTES, 'UTF-8'); ?>" readonly="readonly" />
Data Entrada:
<input name="data" type="text" id="data" value="<?php if ($data==''){echo date('d/m/Y');}else{echo $data;} ?>" size="25" readonly="readonly"/></td>
          ...
          <tr>
            ...
            <td width="308"><input name="modelo" type="text" id="modelo" value="<?php echo htmlentities($modelo, ENT_QUOTES, 'UTF-8'); ?>" size="30" readonly="readonly"/></td>
            <td width="53" style="font-size:10px; font-family: Verdana;">T&eacute;cnico*:</td>
            <td width="214" colspan="3"><input name="equi6" type="text" id="equi6" value="<?php echo htmlentities($codtec, ENT_QUOTES, 'UTF-8'); ?>" readonly="readonly" /></td>
          </tr>
          <tr>
            <td style="font-size:10px; font-family: Verdana;">Acessorio*:</td>
            <td><input name="equi4" type="text" id="equi4" value="<?php echo htmlentities($ace, ENT_QUOTES, 'UTF-8'); ?>" readonly="readonly"/></td>
            <td style="font-size:10px; font-family: Verdana;">Setor:</td>
            <td colspan="3"><input name="setor" type="text" id="setor" value="<?php echo htmlentities($setor, ENT_QUOTES, 'UTF-8'); ?>" readonly="readonly"/></td>
          </tr>
        </table>
      </fieldset></td>
    </tr>
      ...
      <td style="font-size:10px; font-family: Verdana;"><fieldset>
        ...
        <table border="0" cellspacing="8" cellpadding="0">
          <tr>
            ...
            <td colspan="5" style="font-size:12px; font-family: Verdana;"><?php $lll=htmlentities($lll, ENT_QUOTES, 'UTF-8'); echo "<strong style='color:#00f;'>$login - $hora disse:</strong> $lll";?></td>
          </tr>
          <tr>
            ...
            <td width="125"><input name="prazo" type="text" id="prazo" value="<?php echo htmlentities($prazo, ENT_QUOTES, 'UTF-8');?>" size="20" readonly="readonly"/></td>
            <td width="91" style="font-size:10px; font-family: Verdana;">Dispo. das pe&ccedil;as*:</td>
            <td width="100"><input name="dis" type="text" id="dis" value="<?php echo htmlentities($dis, ENT_QUOTES, 'UTF-8'); ?>" size="20" readonly="readonly"/></td>
          </tr>
          <tr>
			...
			while ($row = mysql_fetch_array($stt))
			{
				...
				$stax = utf8_encode($row['descricao']);
				$stax = htmlentities($stax, ENT_QUOTES, 'UTF-8');
				echo "<strong>$stax</strong>";
			}
              ?></td>
          </tr>
          <tr>
...
<hr />
  <table width="0%" border="0" align="center" cellpadding="0" cellspacing="5">
    ...
    <tr>
      <td align="center">
        <input type="submit" name="button" id="button" value="REGISTRAR"/></td>
    </tr>
  </table>
</form>
