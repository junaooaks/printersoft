      ...
      <td style="font-size:10px; font-family: Verdana;"><fieldset>
        ...
        <table border="0" cellspacing="8" cellpadding="0">
          <tr>
            ...
            <td colspan="5" style="font-size:12px; font-family: Verdana;"><?php echo "<strong style='color:#00f;'>$login - $hora disse:</strong>".htmlentities($lll,ENT_QUOTES, 'UTF-8');?></td>
          </tr>
          <tr>
...
N&Atilde;O AUTORIZAR              
              ...
              <p>mandar esta informa&ccedil;&atilde;o pelo email .</p></td>
          </tr>
        </table>
      </fieldset></td>
    </tr>
