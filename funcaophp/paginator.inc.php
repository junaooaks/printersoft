 ...
 */
 ...
 if(empty($_pagi_cuantos)){
	...
	// $_pagi_cuantos será por defecto 10
	$_pagi_cuantos = 30;
 }
 ...
 */
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	...
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_i."&departamento=".$departamento."&inicial=".$inicial."&final=".$final."&cliente=".$cliente."&status=".$status."&pag=".$pag."'>".$_pagi_i."</a>";
	}
 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."&departamento=".$departamento."&inicial=".$inicial."&final=".$final."&cliente=".$cliente."&status=".$status."&pag=".$pag."'>$_pagi_nav_siguiente</a>";
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url. "&departamento=".$departamento."&inicial=".$inicial."&final=".$final."&cliente=".$cliente."&status=".$status."&pag=".$pag."'>$_pagi_nav_ultima</a>";
 }
