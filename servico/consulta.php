...
<form method="post" action="" name="" >
  <table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><input type="submit" name="novo" value="Incluir Disponibilidade do Serviço" onclick="send('novo');"/></td>
    </tr>
  </table>
  <hr />
  <table align="center">
...
<tr>
    <th id="th1">Disponibilidade do Servi&ccedil;o</th>
