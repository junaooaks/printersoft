...
<div align="center">
	...
	$cep=$s;
			 ...
			 if ($cod=='')
			  {
			  		$my = "INSERT INTO cliente (pessoaJuridica, estado, endereco, cpf, cidade, bairro, telComercial, celular, cep, email) 
					...
					$sq = "SELECT idCliente FROM cliente WHERE pessoaJuridica='$nome' LIMIT 1";
